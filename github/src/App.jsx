      ...
      <div className="w-full max-w-xl mx-auto mt-16">
        <div className="mb-12">
          <h1 className="text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-violet-400 to-cyan-400 text-center tracking-tight">
            We <span className="line-through text-white line-through">hate</span> love your GitHub profile.
          </h1>

          <h2 className='text-lg text-zinc-400 mt-[50px] text-center mt-4'>
            It will take 10-15 seconds to <span style={{ textDecoration: 'line-through' }}>roast</span> analyze your GitHub profile.
          </h2>
        </div>
